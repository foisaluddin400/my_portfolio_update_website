...
export default function HomePage({aboutData, blogsData, skillsData, profileData, projectsData, reviewsData, servicesData, resumeData}) {
  ...
  // ✅ Scroll-based active detection — সবচেয়ে reliable
  useEffect(() => {
    const handleScroll = () => {
      ...
      sections.forEach((section) => {
        ...
        // Viewport এর 30% উপর থেকে section শুরু হলেই active
  ...
  const scrollToSection = (id) => {
    ...
    // Smooth scroll শেষ হওয়ার পর observer চালু
    setTimeout(() => {
    ...
    <div className="text-white selection:bg-[#72ebc2]/30">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-[25%_65%_5%] gap-8 md:gap-12 relative">
            ...
            <div className="relative p-[1.6px] overflow-hidden rounded-3xl bg-gradient-to-br from-white/5 to-white/2 bg-[#151a18] backdrop-blur-xl group">
              ...
              <div className="relative bg-[#151a18f5] rounded-[22px] overflow-hidden">
                ...
                <div className="p-6 text-center">
                  <h1 className="text-xl font-bold tracking-tight">Momtaj Uddin</h1>
        ...
        <main className="w-full">
          <div className="space-y-16 py-8 px-4 lg:px-0 pb-24 md:pb-10">
            <Suspense fallback={<div className="h-screen flex items-center justify-center">Loading...</div>}>
              <section id="about" className="scroll-mt-10"><AboutMe /></section>
              <section id="sectionServices" className="scroll-mt-10"><ServicesSection /></section>
              <section id="resume" className="scroll-mt-10"><ResumeTimeline /></section>
              <section id="skills" className="scroll-mt-10"><SkillSection /></section>
              <section id="projects" className="scroll-mt-10"><ProjectPage /></section>
              <section id="blogs" className="scroll-mt-10"><Blog /></section>
              <section id="clientReviews" className="scroll-mt-10"><ClientReview /></section>
